...
- Stop, pause, session end, screen lock, user switch, sleep, network loss, and peer loss must release input and restore visibility in the documented order while still attempting authenticated revocation.
